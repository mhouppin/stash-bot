...
const scorepair_t BackwardPenalty  = SPAIR( -4, -6);
const scorepair_t StragglerPenalty = SPAIR(-18,-16);
const scorepair_t DoubledPenalty   = SPAIR(-20,-34);
const scorepair_t IsolatedPenalty  = SPAIR( -9, -7);
