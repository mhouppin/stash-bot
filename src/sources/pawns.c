...
const scorepair_t BackwardPenalty  = SPAIR( -3,-18);
const scorepair_t StragglerPenalty = SPAIR(-10,-25);
const scorepair_t DoubledPenalty   = SPAIR(-12,-41);
const scorepair_t IsolatedPenalty  = SPAIR( -7, -4);
...
const scorepair_t PP_OurKingProximity[24] = {
    SPAIR(   3,  56), SPAIR(   4,  14), SPAIR(  -9, -70),
    SPAIR(   0,   0), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(   6,  66), SPAIR(   6,  24), SPAIR(   7, -25),
    SPAIR( -19, -45), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(   6,  65), SPAIR(  -5,  31), SPAIR( -10,  -7),
    SPAIR(  -7, -34), SPAIR(  20, -36), SPAIR(   0,   0),
    SPAIR(  -4,  45), SPAIR( -18,  27), SPAIR(  -9, -10),
    SPAIR(  -1, -10), SPAIR(   8, -15), SPAIR(  27, -22)
};

const scorepair_t PP_TheirKingProximity[24] = {
    SPAIR( -24,-126), SPAIR(   4,  -0), SPAIR(  18, 127),
    SPAIR(   0,   0), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR( -22,-136), SPAIR(  12, -19), SPAIR(  -4,  56),
    SPAIR(  14, 119), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(  -9, -91), SPAIR(  10, -20), SPAIR(  10,   2),
    SPAIR(   5,  53), SPAIR( -12,  75), SPAIR(   0,   0),
    SPAIR(  -6, -52), SPAIR(  -5,  -2), SPAIR(  -5,  -1),
    SPAIR(  18,   6), SPAIR(  -1,  34), SPAIR(  -0,  29)
};
