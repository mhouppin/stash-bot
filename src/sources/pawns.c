...
const scorepair_t BackwardPenalty  = SPAIR( -6, -8);
const scorepair_t StragglerPenalty = SPAIR(-19,-23);
const scorepair_t DoubledPenalty   = SPAIR(-19,-41);
const scorepair_t IsolatedPenalty  = SPAIR(-10, -8);
