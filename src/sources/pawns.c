...
const scorepair_t BackwardPenalty  = SPAIR( -6,-10);
const scorepair_t StragglerPenalty = SPAIR(-13,-17);
const scorepair_t DoubledPenalty   = SPAIR(-14,-47);
const scorepair_t IsolatedPenalty  = SPAIR( -9, -4);
...
const scorepair_t PP_OurKingProximity[24] = {
    SPAIR(   3,  57), SPAIR(   4,  14), SPAIR( -12, -72),
    SPAIR(   0,   0), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(   6,  66), SPAIR(   6,  24), SPAIR(   6, -26),
    SPAIR( -20, -48), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(   6,  66), SPAIR(  -3,  27), SPAIR( -12,  -6),
    SPAIR(  -8, -39), SPAIR(  22, -36), SPAIR(   0,   0),
    SPAIR(  -4,  54), SPAIR( -22,  29), SPAIR(  -6, -14),
    SPAIR(   3, -12), SPAIR(   6, -18), SPAIR(  24, -24)
};

const scorepair_t PP_TheirKingProximity[24] = {
    SPAIR( -24,-130), SPAIR(   3,   0), SPAIR(  16, 130),
    SPAIR(   0,   0), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR( -21,-136), SPAIR(  12, -18), SPAIR(  -4,  56),
    SPAIR(  12, 115), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(  -9, -96), SPAIR(  12, -21), SPAIR(  11,   6),
    SPAIR(   3,  50), SPAIR( -11,  73), SPAIR(   0,   0),
    SPAIR(  -6, -48), SPAIR(  -7,   1), SPAIR(  -4,  -1),
    SPAIR(  19,   0), SPAIR(  -1,  33), SPAIR(  -1,  29)
};
