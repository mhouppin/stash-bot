...
const scorepair_t BackwardPenalty  = SPAIR( -5,-10);
const scorepair_t StragglerPenalty = SPAIR(-14,-22);
const scorepair_t DoubledPenalty   = SPAIR(-19,-45);
const scorepair_t IsolatedPenalty  = SPAIR( -4,-10);
...
const scorepair_t PP_OurKingProximity[24] = {
    SPAIR(   3,  56), SPAIR(   4,  13), SPAIR(  -7, -74),
    SPAIR(   0,   0), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(   6,  64), SPAIR(   6,  21), SPAIR(   7, -27),
    SPAIR( -21, -54), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(   6,  59), SPAIR(  -1,  30), SPAIR( -11, -10),
    SPAIR( -13, -37), SPAIR(  21, -38), SPAIR(   0,   0),
    SPAIR(  -2,  46), SPAIR( -16,  24), SPAIR( -12, -10),
    SPAIR(  -3, -14), SPAIR(   7, -16), SPAIR(  27, -22)
};

const scorepair_t PP_TheirKingProximity[24] = {
    SPAIR( -24,-131), SPAIR(   4,   0), SPAIR(  19, 128),
    SPAIR(   0,   0), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR( -21,-136), SPAIR(   8, -25), SPAIR(  -2,  55),
    SPAIR(  15, 110), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(  -9, -95), SPAIR(   8, -27), SPAIR(   6,   5),
    SPAIR(   4,  50), SPAIR(  -6,  73), SPAIR(   0,   0),
    SPAIR(  -6, -50), SPAIR(  -7,  -5), SPAIR(  -4,  -0),
    SPAIR(  12,   1), SPAIR(   1,  34), SPAIR(   3,  29)
};
