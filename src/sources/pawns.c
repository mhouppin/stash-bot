...
const scorepair_t StragglerPenalty = SPAIR(-13,-19);
const scorepair_t DoubledPenalty   = SPAIR(-13,-46);
...
const scorepair_t PP_OurKingProximity[24] = {
    SPAIR(   4,  67), SPAIR(   5,  12), SPAIR( -20, -83),
    SPAIR(   0,   0), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(   7,  71), SPAIR(   9,  27), SPAIR(  10, -25),
    SPAIR( -29, -63), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(   7,  65), SPAIR(  -2,  32), SPAIR( -12, -12),
    SPAIR( -11, -36), SPAIR(  19, -39), SPAIR(   0,   0),
    SPAIR(  -7,  50), SPAIR( -26,  30), SPAIR(  -8, -12),
    SPAIR(   3, -16), SPAIR(  13, -19), SPAIR(  28, -20)
};

const scorepair_t PP_TheirKingProximity[24] = {
    SPAIR( -26,-148), SPAIR(   1,   7), SPAIR(  15, 138),
    SPAIR(   0,   0), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR( -22,-142), SPAIR(   1, -29), SPAIR(   5,  61),
    SPAIR(  13, 119), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(  -6, -91), SPAIR(  14, -27), SPAIR(  10,   0),
    SPAIR(   0,  49), SPAIR( -17,  80), SPAIR(   0,   0),
    SPAIR(  -6, -43), SPAIR(  -8,  -5), SPAIR(  -1,  -3),
    SPAIR(  11,  -0), SPAIR(  -4,  34), SPAIR(  10,  29)
};
