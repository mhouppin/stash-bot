...
const scorepair_t StragglerPenalty = SPAIR(-13,-21);
...
const scorepair_t PP_OurKingProximity[24] = {
    SPAIR(   3,  58), SPAIR(   4,  14), SPAIR( -11, -77),
    SPAIR(   0,   0), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(   6,  65), SPAIR(   7,  25), SPAIR(   8, -24),
    SPAIR( -23, -57), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(   6,  64), SPAIR(  -2,  32), SPAIR( -11, -13),
    SPAIR( -11, -36), SPAIR(  18, -39), SPAIR(   0,   0),
    SPAIR(  -5,  48), SPAIR( -18,  30), SPAIR( -11, -13),
    SPAIR(   2, -13), SPAIR(   9, -17), SPAIR(  28, -21)
};

const scorepair_t PP_TheirKingProximity[24] = {
    SPAIR( -25,-137), SPAIR(   3,   3), SPAIR(  19, 131),
    SPAIR(   0,   0), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR( -21,-138), SPAIR(   3, -26), SPAIR(   2,  58),
    SPAIR(  15, 116), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(  -8, -92), SPAIR(  11, -26), SPAIR(  10,   3),
    SPAIR(   2,  49), SPAIR( -14,  74), SPAIR(   0,   0),
    SPAIR(  -6, -47), SPAIR(  -7,  -5), SPAIR(  -2,  -1),
    SPAIR(  14,  -0), SPAIR(  -2,  34), SPAIR(   7,  31)
};
