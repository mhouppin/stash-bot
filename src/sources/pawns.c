...
const scorepair_t BackwardPenalty  = SPAIR( -5, -9);
const scorepair_t StragglerPenalty = SPAIR(-15,-21);
const scorepair_t DoubledPenalty   = SPAIR(-13,-45);
...
const scorepair_t PP_OurKingProximity[24] = {
    SPAIR(   3,  57), SPAIR(   4,  14), SPAIR(  -6, -75),
    SPAIR(   0,   0), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(   6,  63), SPAIR(   6,  21), SPAIR(   7, -24),
    SPAIR( -21, -54), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(   6,  61), SPAIR(  -1,  33), SPAIR( -10, -13),
    SPAIR( -12, -34), SPAIR(  17, -37), SPAIR(   0,   0),
    SPAIR(  -3,  47), SPAIR( -17,  27), SPAIR( -11, -12),
    SPAIR(  -0, -11), SPAIR(   7, -17), SPAIR(  28, -20)
};

const scorepair_t PP_TheirKingProximity[24] = {
    SPAIR( -23,-130), SPAIR(   4,   1), SPAIR(  20, 126),
    SPAIR(   0,   0), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR( -21,-135), SPAIR(   7, -27), SPAIR(  -1,  55),
    SPAIR(  15, 112), SPAIR(   0,   0), SPAIR(   0,   0),
    SPAIR(  -8, -94), SPAIR(  11, -24), SPAIR(   5,   4),
    SPAIR(   2,  50), SPAIR(  -9,  74), SPAIR(   0,   0),
    SPAIR(  -6, -49), SPAIR(  -7,  -6), SPAIR(  -4,  -0),
    SPAIR(  13,   1), SPAIR(  -1,  36), SPAIR(   7,  29)
};
