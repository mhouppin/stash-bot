...
void uci_loop(int argc, char **argv)
{
    ...
    TUNE_DOUBLE(LMP_IB, -5.0, 5.0);
    TUNE_DOUBLE(LMP_IK,  0.5, 5.0);
    TUNE_DOUBLE(LMP_IN,  0.5, 3.0);
    TUNE_DOUBLE(LMP_NB, -5.0, 5.0);
    TUNE_DOUBLE(LMP_NK,  0.5, 5.0);
    TUNE_DOUBLE(LMP_NN,  0.5, 3.0);
