...
const Scorepair BackwardPenalty = SPAIR(-26, -25);
const Scorepair DoubledPenalty  = SPAIR(-19, -49);
const Scorepair IsolatedPenalty = SPAIR( -8,  -9);
...
const Scorepair PassedOurKingDistance[24] = {
    SPAIR(  64,  132), SPAIR(  85,   31), SPAIR( -19,  -71),
    SPAIR(   0,    0), SPAIR(   0,    0), SPAIR(   0,    0),
    SPAIR(  51,  108), SPAIR(  61,   40), SPAIR(  16,  -32),
    SPAIR( -55,  -58), SPAIR(   0,    0), SPAIR(   0,    0),
    SPAIR(   2,   84), SPAIR( -28,   44), SPAIR( -18,   -6),
    SPAIR(  -5,  -41), SPAIR(  41,  -50), SPAIR(   0,    0),
    SPAIR( -41,   61), SPAIR( -30,   37), SPAIR(  -8,   -9),
    SPAIR( -13,  -14), SPAIR(  27,  -19), SPAIR(  47,  -28)
};

const Scorepair PassedTheirKingDistance[24] = {
    SPAIR(   8, -150), SPAIR(  19,   20), SPAIR(  20,  192),
    SPAIR(   0,    0), SPAIR(   0,    0), SPAIR(   0,    0),
    SPAIR( -35, -119), SPAIR(  34,  -37), SPAIR(   8,   56),
    SPAIR(  15,  143), SPAIR(   0,    0), SPAIR(   0,    0),
    SPAIR( -30,  -74), SPAIR(  21,  -35), SPAIR(  14,   -3),
    SPAIR(  -6,   53), SPAIR( -25,   93), SPAIR(   0,    0),
    SPAIR( -60,  -33), SPAIR( -20,   -1), SPAIR(  18,   -6),
    SPAIR(  27,   -5), SPAIR(  -4,   43), SPAIR(   0,   30)
};
