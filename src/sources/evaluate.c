...
// Special eval terms
const Scorepair Initiative = SPAIR(25, 29);
...
const Scorepair BishopLongDiagonal = SPAIR( 13,  23);

const Scorepair BishopPawnsSameColor[7] = {
    SPAIR( 15,  39), SPAIR( 16,  28), SPAIR( 13,  19), SPAIR(  9,  13),
...
const Scorepair KnightMobility[9] = {
    SPAIR( -55,   17), SPAIR( -44,  -31), SPAIR( -34,   35), SPAIR( -25,   58),
...
const Scorepair BishopMobility[14] = {
    ...
    SPAIR( -16,   32), SPAIR( -13,   47), SPAIR(  -9,   57), SPAIR(  -8,   63),
    SPAIR(  -7,   66), SPAIR(  -5,   70), SPAIR(  -1,   63), SPAIR(   9,   60),
    SPAIR(  11,   59), SPAIR(  26,   51)
};

const Scorepair RookMobility[15] = {
    SPAIR( -94,  -35), SPAIR( -37,   43), SPAIR( -25,   79), SPAIR( -30,   95),
    SPAIR( -27,  106), SPAIR( -31,  119), SPAIR( -32,  128), SPAIR( -26,  131),
    SPAIR( -23,  140), SPAIR( -15,  149), SPAIR( -14,  155), SPAIR(  -9,  161),
    SPAIR(  -1,  163), SPAIR(   9,  165), SPAIR(  25,  159)
};

const Scorepair QueenMobility[28] = {
    SPAIR( -50, -138), SPAIR(  24,  192), SPAIR(   4,  153), SPAIR(  -3,  114),
    SPAIR(   4,   73), SPAIR(   1,  119), SPAIR(   0,  151), SPAIR(   0,  176),
    SPAIR(   1,  186), SPAIR(   1,  206), SPAIR(   3,  215), SPAIR(   6,  220),
    SPAIR(   6,  229), SPAIR(   9,  233), SPAIR(   8,  238), SPAIR(   8,  244),
    SPAIR(  11,  244), SPAIR(  13,  242), SPAIR(  19,  232), SPAIR(  18,  233),
    SPAIR(  41,  206), SPAIR(  42,  201), SPAIR(  44,  190), SPAIR(  28,  170),
...
const Scorepair FarRook   = SPAIR(-10,   4);
...
const Scorepair SafeQueenCheck  = SPAIR(  48,  124);
const Scorepair UnsafeCheck     = SPAIR(  18,   84);
const Scorepair QueenlessAttack = SPAIR( -86,  -29);
const Scorepair SafetyOffset    = SPAIR(  29,   40);
...
const Scorepair KingStorm[24] = {
    SPAIR(  -4,   -3), SPAIR( -25,   -1), SPAIR(   9,    9), SPAIR(  -8,    7),
    SPAIR( -26,   17), SPAIR( -26,    6), SPAIR( -47,   -2), SPAIR( -20,  -14),
    SPAIR(   0,    0), SPAIR(   0,   -8), SPAIR(  34,   16), SPAIR(   6,   -6),
    SPAIR(  -3,   -6), SPAIR(  -4,   12), SPAIR(   7,   33), SPAIR(  18,   -3),
    SPAIR(  15,   -1), SPAIR(   7,    0), SPAIR(  35,    4), SPAIR(  25,   -6),
    SPAIR(  -6,   -8), SPAIR( -13,   26), SPAIR(  -4,   64), SPAIR(  -1,  -41)
};

const Scorepair KingShelter[24] = {
    SPAIR( -51,   10), SPAIR( -39,   87), SPAIR( -39,  -28), SPAIR( -25,    6),
    SPAIR(   7,   -4), SPAIR(  12,   -3), SPAIR(  -8,    0), SPAIR(  -9,  -51),
    SPAIR(   0,    0), SPAIR(  -4,  -20), SPAIR(  -4,   55), SPAIR(   3,   29),
    SPAIR(  12,   13), SPAIR(  35,    0), SPAIR(   4,    0), SPAIR(  15,  -36),
    SPAIR( -30,  -28), SPAIR(  13,  -91), SPAIR(   3,   53), SPAIR(  12,   78),
    SPAIR(  14,   18), SPAIR(  20,    0), SPAIR(  10,    0), SPAIR(  17,    9)
};

// Threat eval terms
const Scorepair PawnThreats[6] = {
    SPAIR( -4, -13), SPAIR( 72,  65), SPAIR( 69, 109),
    SPAIR( 66,  60), SPAIR( 64,  18), 0
};

const Scorepair KnightThreats[6] = {
    SPAIR(-10,   8), SPAIR(  5,  13), SPAIR( 42,  56),
    SPAIR( 94,  45), SPAIR( 47,  51), 0
};

const Scorepair BishopThreats[6] = {
    SPAIR( -3,   4), SPAIR( 15,  50), SPAIR(  6,  19),
    SPAIR( 56,  75), SPAIR( 59, 103), 0
};

const Scorepair RookThreats[6] = {
    SPAIR(-10,  16), SPAIR(  8,  28), SPAIR( 24,  22),
    SPAIR(  9,   9), SPAIR( 51,  58), 0
};

const Scorepair QueenThreats[6] = {
    SPAIR(  0,   9), SPAIR(  2,  13), SPAIR( -2,  35),
