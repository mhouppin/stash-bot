...
// Special eval terms
const Scorepair Initiative = SPAIR(23, 28);

// Knight eval terms
const Scorepair KnightShielded = SPAIR(  6,  24);
const Scorepair KnightOutpost  = SPAIR( 26,  31);

const Scorepair ClosedPosKnight[5] = {
    SPAIR( 10, -12), SPAIR( 11,  14), SPAIR( 13,  27), SPAIR( 11,  33),
    SPAIR( 17,  51)
};

// Bishop eval terms
const Scorepair BishopPairBonus    = SPAIR( 26, 104);
const Scorepair BishopShielded     = SPAIR(  4,   8);
const Scorepair BishopOutpost      = SPAIR( 46,  28);
const Scorepair BishopLongDiagonal = SPAIR( 12,  23);

const Scorepair BishopPawnsSameColor[7] = {
    SPAIR( 13,  43), SPAIR( 15,  36), SPAIR( 15,  23), SPAIR( 11,  14),
    SPAIR(  6,   5), SPAIR(  3,  -4), SPAIR( -2, -14)
};

// Rook eval terms
const Scorepair RookOnSemiOpenFile = SPAIR( 12,  20);
const Scorepair RookOnOpenFile     = SPAIR( 35,  14);
const Scorepair RookOnBlockedFile  = SPAIR(-10,  -7);
const Scorepair RookXrayQueen      = SPAIR( 10,   7);
const Scorepair RookTrapped        = SPAIR( -5, -12);
const Scorepair RookBuried         = SPAIR(-66, -27);

// Mobility eval terms
const Scorepair KnightMobility[9] = {
    SPAIR( -53,   23), SPAIR( -40,  -31), SPAIR( -30,   33), SPAIR( -25,   63),
    SPAIR( -19,   79), SPAIR( -15,   95), SPAIR(  -8,  110), SPAIR(  -2,  119),
    SPAIR(   1,  109)
};

const Scorepair BishopMobility[14] = {
    SPAIR( -46,  -29), SPAIR( -42,  -42), SPAIR( -30,  -11), SPAIR( -27,   15),
    SPAIR( -21,   37), SPAIR( -13,   51), SPAIR(  -7,   57), SPAIR(  -5,   67),
    SPAIR(  -8,   64), SPAIR(   2,   68), SPAIR(  -2,   67), SPAIR(   4,   63),
    SPAIR(  20,   62), SPAIR(  52,   48)
};

const Scorepair RookMobility[15] = {
    SPAIR( -87,  -39), SPAIR( -37,   37), SPAIR( -29,   76), SPAIR( -32,   91),
    SPAIR( -32,  110), SPAIR( -35,  123), SPAIR( -34,  129), SPAIR( -27,  135),
    SPAIR( -23,  147), SPAIR( -17,  155), SPAIR( -14,  163), SPAIR(  -4,  171),
    SPAIR(  -6,  176), SPAIR(   2,  179), SPAIR(  21,  172)
};

const Scorepair QueenMobility[28] = {
    SPAIR(   2,  -58), SPAIR(   2,  218), SPAIR(   7,  152), SPAIR(   2,  111),
    SPAIR(  -2,   79), SPAIR(  -2,  123), SPAIR(  -4,  148), SPAIR(  -4,  172),
    SPAIR(  -2,  185), SPAIR(  -2,  203), SPAIR(  -1,  221), SPAIR(   0,  222),
    SPAIR(   2,  232), SPAIR(   6,  235), SPAIR(   8,  237), SPAIR(   4,  245),
    SPAIR(   9,  248), SPAIR(  15,  240), SPAIR(  20,  233), SPAIR(  15,  237),
    SPAIR(  38,  205), SPAIR(  36,  203), SPAIR(  47,  182), SPAIR(  48,  175),
    SPAIR(  60,  149), SPAIR(   9,  158), SPAIR(  19,  173), SPAIR(  37,  141)
};
...
const Scorepair FarKnight = SPAIR(-20, -11);
const Scorepair FarBishop = SPAIR( -9,  -8);
const Scorepair FarRook   = SPAIR(-15,   8);
const Scorepair FarQueen  = SPAIR( -7,  17);

// King Safety eval terms
const Scorepair KnightWeight    = SPAIR(  49,   94);
const Scorepair BishopWeight    = SPAIR(  37,  131);
const Scorepair RookWeight      = SPAIR(  34,  -41);
const Scorepair QueenWeight     = SPAIR(  12,   -3);
const Scorepair AttackWeight    = SPAIR(  10,   39);
const Scorepair WeakKingZone    = SPAIR(  24,  -68);
const Scorepair SafeKnightCheck = SPAIR(  70,   48);
const Scorepair SafeBishopCheck = SPAIR(  29,  205);
const Scorepair SafeRookCheck   = SPAIR(  82,  203);
const Scorepair SafeQueenCheck  = SPAIR(  43,  237);
const Scorepair UnsafeCheck     = SPAIR(  16,  117);
const Scorepair QueenlessAttack = SPAIR( -88,  -86);
const Scorepair SafetyOffset    = SPAIR(  17,   55);
...
const Scorepair KingStorm[24] = {
    SPAIR(  -1,  -28), SPAIR( -35,  -19), SPAIR(  25,   36), SPAIR(   6,   19),
    SPAIR(  -7,   26), SPAIR( -14,    5), SPAIR( -32,  -11), SPAIR(   3,  -41),
    SPAIR(   0,    0), SPAIR(  -6,  -14), SPAIR(  40,   66), SPAIR(   0,  -12),
    SPAIR(  -8,  -24), SPAIR(  -8,   22), SPAIR(   5,   58), SPAIR(  16,  -17),
    SPAIR(   8,   15), SPAIR(  17,   -2), SPAIR(  36,   24), SPAIR(  25,   -7),
    SPAIR(  -4,  -21), SPAIR( -19,   48), SPAIR( -14,  120), SPAIR(   3,  -90)
};

const Scorepair KingShelter[24] = {
    SPAIR( -40,   26), SPAIR( -23,  156), SPAIR( -25,  -55), SPAIR(  -5,   17),
    SPAIR(  19,  -15), SPAIR(  21,  -27), SPAIR( -28,   -4), SPAIR(   5, -119),
    SPAIR(   0,    0), SPAIR(  -7,  -34), SPAIR( -10,   92), SPAIR(  -2,   82),
    SPAIR(  15,   59), SPAIR(  30,  -19), SPAIR(  12,    1), SPAIR(  14,  -90),
    SPAIR( -30,  -63), SPAIR(  13, -185), SPAIR(  -4,  131), SPAIR(  10,  192),
    SPAIR(   3,   53), SPAIR(  13,   -4), SPAIR(   7,   -4), SPAIR(  12,  -10)
};

// Threat eval terms
const Scorepair PawnThreats[6] = {
    SPAIR(  5, -52), SPAIR( 69,  62), SPAIR( 59, 101),
    SPAIR( 59,  73), SPAIR( 58,  25), 0
};

const Scorepair KnightThreats[6] = {
    SPAIR( -7,  11), SPAIR(  1,  60), SPAIR( 41,  56),
    SPAIR( 84,  47), SPAIR( 50,  35), 0
};

const Scorepair BishopThreats[6] = {
    SPAIR( -4,  11), SPAIR( 21,  54), SPAIR(  3,  55),
    SPAIR( 57,  82), SPAIR( 51, 150), 0
};

const Scorepair RookThreats[6] = {
    SPAIR(-10,  21), SPAIR( 12,  37), SPAIR( 20,  27),
    SPAIR( 13,  27), SPAIR( 68,  70), 0
};

const Scorepair QueenThreats[6] = {
    SPAIR(  1,   9), SPAIR(  1,  11), SPAIR( -9,  49),
    SPAIR( -4,   1), SPAIR( 20,  11), 0
};

const Scorepair HangingPawn = SPAIR( 10,  56);
