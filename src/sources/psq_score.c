...
const scorepair_t PawnBonus[RANK_NB][FILE_NB] = {
    { },
    { S( -9, 21), S( -6, 20), S(-16, 14), S( -1,  2), S( -1, 13), S( 34, 21), S( 36, 13), S(  7,-15) },
    { S( -7, 15), S(-18, 18), S(  1,  8), S(  2,  5), S(  8, 10), S(  6, 14), S( 20, -3), S(  8,-11) },
    { S(-10, 20), S( -9, 13), S(  6, -8), S( 12,-18), S( 19,-13), S( 17, -5), S( 14, -5), S( -3, -9) },
    { S( -0, 38), S( -5, 21), S(  3,  2), S( 23,-20), S( 38,-13), S( 44,-11), S( 16,  5), S(  9,  9) },
    { S(  4, 53), S(  5, 40), S( 25, 10), S( 40,-23), S( 48,-20), S(112,  4), S( 65, 22), S( 29, 26) },
...
const scorepair_t PieceBonus[PIECETYPE_NB][RANK_NB][FILE_NB / 2] = {
    ...
    // Knight
    {
        { S( -64, -37), S( -14, -38), S( -30,  -9), S( -19,   8) },
        { S( -22, -11), S( -24,   7), S( -12,  -8), S(  -6,   7) },
        { S( -16, -19), S(  -6,   2), S(  -1,   6), S(   9,  31) },
        { S(  -7,  22), S(  13,  31), S(   8,  41), S(  11,  48) },
        { S(   3,  36), S(   3,  36), S(  26,  41), S(   8,  56) },
    ...
    // Bishop
    {
        { S(  -4, -10), S(   8,   7), S( -14,  14), S( -22,  19) },
        { S(   1,   1), S(   4,   0), S(   5,  19), S( -10,  28) },
        { S(  -2,  16), S(   5,  29), S(  -3,  23), S(  -0,  51) },
        { S(  -2,   4), S(   4,  37), S(  -1,  56), S(  18,  66) },
        { S( -15,  24), S(   3,  50), S(  19,  52), S(  21,  69) },
        { S(   3,  28), S(   7,  52), S(  20,  34), S(  21,  47) },
        { S( -63,  30), S( -57,  27), S( -23,  45), S( -21,  41) },
        { S( -69,  35), S( -58,  44), S(-151,  50), S(-117,  48) }
    },

    // Rook
    {
        { S( -30,   2), S( -28,  11), S( -20,  14), S( -16,  11) },
        { S( -58,   5), S( -39,   6), S( -28,  11), S( -29,  11) },
        { S( -50,  19), S( -30,  23), S( -41,  28), S( -37,  26) },
        { S( -47,  40), S( -34,  46), S( -36,  46), S( -26,  36) },
        { S( -28,  58), S( -16,  65), S(   2,  56), S(  12,  57) },
        { S( -18,  67), S(  13,  61), S(  21,  66), S(  41,  55) },
        { S(  -3,  71), S( -10,  72), S(  31,  70), S(  40,  72) },
        { S(  11,  65), S(  21,  69), S(   7,  67), S(  15,  63) }
    },

    // Queen
    {
        { S(  15, -45), S(  11, -55), S(  15, -65), S(  20, -33) },
        { S(  11, -41), S(  18, -40), S(  22, -31), S(  19, -13) },
        { S(  15, -15), S(  16,   6), S(  10,  29), S(   3,  29) },
        { S(   6,  29), S(  16,  38), S(   1,  61), S(   1,  73) },
        { S(  14,  37), S(  -0,  78), S(   2,  83), S(  -5,  98) },
        { S(   7,  43), S(   5,  68), S(  -3, 108), S(  -5, 109) },
    ...
    // King
    {
        { S( 282,  11), S( 298,  57), S( 223,  68), S( 164,  80) },
        { S( 290,  57), S( 274,  87), S( 247,  99), S( 225, 103) },
