...
const scorepair_t BishopSQT[32] = {
    ...
    S(  36,  -2), S(  19,  32), S(  30,   7), S(  43,  21),
    S( -63,  -3), S( -64, -13), S( -10,  15), S( -10,  10),
...
const scorepair_t RookSQT[32] = {
    ...
    S( -13,  29), S(  26,  22), S(  30,  24), S(  56,  15),
...
const scorepair_t QueenSQT[32] = {
    ...
    S( -29,  25), S( -19,  40), S( -14,  59), S( -17,  66)
};

const scorepair_t KingSQT[32] = {
    S(  39,-123), S(  44, -58), S( -41, -44), S( -36, -61),
    S(  35, -55), S(   3, -21), S( -20,  -7), S( -50,  -3),
