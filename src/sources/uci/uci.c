...
void	uci_loop(int argc, char **argv)
{
	...
	add_option_spin_flt(&g_opthandler, "TimeburnRatio", &g_options.burn_ratio, 1, 0, 10, NULL);
	add_option_spin_flt(&g_opthandler, "TimesaveRatio", &g_options.save_ratio, 1, 0, 10, NULL);
