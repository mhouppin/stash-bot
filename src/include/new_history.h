...
static_assert(sizeof(ButterflyHistory) % 64 == 0);
static_assert(sizeof(ContinuationHistory) % 64 == 0);
static_assert(sizeof(CountermoveHistory) % 64 == 0);
static_assert(sizeof(CaptureHistory) % 64 == 0);
static_assert(sizeof(CorrectionHistory) % 64 == 0);
